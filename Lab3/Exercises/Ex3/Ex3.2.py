...
director = "S:\III\Sem II\AI\AI_Labs_Python\Lab3\Exercises\Ex3"
fisier_1 = "\citire.csv"
...
list_of_str = ['Observatii', 'Python', 'Qualica', 'Delmia', 'PLC']
add_column_in_csv(cale_1,cale_2, lambda linie, line_num: linie.append(list_of_str[line_num-1]))
